...
* **[BUG-01] (ALTO) — Recuperação de senha não implementada**
  * Passos:
...
* **[BUG-02] (ALTO) — Notícias não atualizam**
  * Passos:
    1. Acessar a tela inicial de notícias.
    2. Tentar recarregar.
  * Esperado: O aplicativo deve trazer as publicações e informações mais recentes.
  * Encontrado: O feed permanece o mesmo, os dados não são atualizados.

### Observações e Comportamentos Inesperados

* **[BUG-03] (MÉDIO) — Validação de e-mail insuficiente no Login**
  * Passos:
...
* **[BUG-04] (MÉDIO) — Autenticação sucedida mesmo com senha incorreta**
  * Passos:
    1. Inserir um e-mail válido.
    2. Tentar realizar o login repetidas vezes com uma senha incorreta.
  * Esperado: Avisar o usuário que as credenciais estão incorretas.
  * Encontrado: O sistema autentica o usuário.


* **[BUG-05] (MÉDIO) — Falha no carregamento das imagens das notícias**
  * Passos:
...
* **[BUG-06] (MÉDIO) — Dashboard de Insights com quebra de layout no modo retrato**
  * Passos:
...
* **[BUG-07] (BAIXO) — Pesquisa não ignora acentuação**
  * Passos:
